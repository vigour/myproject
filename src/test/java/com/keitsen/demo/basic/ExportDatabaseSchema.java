package com.keitsen.demo.basic;
 ...
 */
public class ExportDatabaseSchema extends AbstractTestCase {

	@Test
	public void exportDatabaseSchema() {
		// 加载Spring配置
		String configLocation = "classpath:config/applicationContext.xml";// Spring配置文件
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				configLocation);

		// 参考《Spring3.x企业应用开发实战》的P118-120页
		LocalSessionFactoryBean sessionFactory = (LocalSessionFactoryBean) ctx
